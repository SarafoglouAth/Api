...
{
    [DbContext(typeof(PeopleCertProjectContext))]
    [Migration("20240115165941_MarkerAssignements")]
    partial class MarkerAssignements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.CandidateExam", b =>
                {
                    ...
                    b.Property<DateTime>("ExamPurchaseDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Data.Models.MarkerAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Models.MarkerAssignment", b =>
                {
                    ...
                    b.HasOne("Data.Models.User", "CreatedBy")
                        .WithMany("MarkerAssignmentsCreatedBy")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Data.Models.User", "Marker")
                        .WithMany("MarkerAssignments")
                    ...
                    b.HasOne("Data.Models.User", "UpdatedBy")
                        .WithMany("MarkerAssignmentsUpdatedBy")
                        .HasForeignKey("UpdatedById")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Models.User", b =>
                {
                    ...
                    b.Navigation("MarkerAssignmentsCreatedBy");

                    b.Navigation("MarkerAssignmentsUpdatedBy");
